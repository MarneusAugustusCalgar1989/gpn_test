  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        isCorrect: false,
        aftershok:
          'Несмотря на стиль и всю прекрасность кедов, лучше все же выбрать йоба-ботинки, ведь они защитят от всего, а еще и удобные',
        questionAsset:
      ...
      },
      {
        ...
        isCorrect: false,
        aftershok:
          'Несмотря на всё удобство, тапочки предельно небезопасны на производстве, поэтому стоит выбрать йоба-ботинки.',
        questionAsset:
